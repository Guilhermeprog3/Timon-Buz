...
const MenuOptionsCompany: React.FC<MenuOptionsProps> = ({ logout, deleteUserAccount, profile, user }) => {
    ...
    <View>
        <View style={styles.profileHeader}>
            <View style={styles.avatar}>
                <Ionicons name="business" size={40} color={theme.textPrimary} />
            </View>
...
export default MenuOptionsCompany;